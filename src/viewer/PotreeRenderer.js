...
export class PotreeRenderer {
  ...
  render(params) {
    ...
    const camera =
        params.camera ? params.camera : viewer.scene.getActiveCamera();
    ...
    renderer.render(
        ...
        viewer.scene.cameraScreenSpace); // viewer.scene.cameraScreenSpace);
    ...
    viewer.dispatchEvent(
        {type : "render.pass.perspective_overlay", viewer : viewer});
    ...
    // renderer.setViewport(renderer.domElement.clientWidth -
    // viewer.navigationCube.width, 							renderer.domElement.clientHeight -
    // viewer.navigationCube.width, 							viewer.navigationCube.width,
    // viewer.navigationCube.width); renderer.render(viewer.navigationCube,
    // viewer.navigationCube.camera); renderer.setViewport(0, 0,
